...
class Rainy_Streak:
    ...
    def __init__(self, df_to_proccess, file_name):
        ...
        for month in self.separated_months:
            rainy_days_count, rainy_streak_count, rainy_streak_med_long, streak_counter_if_length_more_than_one, irregularity_index = \
                self.get_rainy_streak_data(month)
    ...
    def get_rainy_streak_data(self, data):
        ...
        return rainy_days_count, rainy_streak_count, rainy_streak_med_long, \
               streak_counter_if_length_more_than_one, irregularity_index
